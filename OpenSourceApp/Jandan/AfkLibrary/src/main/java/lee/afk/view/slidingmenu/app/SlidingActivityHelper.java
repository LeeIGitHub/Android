package lee.afk.view.slidingmenu.app;
...
import lee.afk.R;
import lee.afk.view.slidingmenu.SlidingMenu;
...
public class SlidingActivityHelper {
	...
	/**
	 * Instantiates get new SlidingActivityHelper.
	 *
	...
	/**
	 * Sets mSlidingMenu as get newly inflated SlidingMenu. Should be called within the activitiy's onCreate()
	 *
	...
	/**
	 * Finds get view that was identified by the id attribute from the XML that was processed in onCreate(Bundle).
	 * 
	 ...
	 * hierarchy. It can itself be get complex view hierarchy. When calling this method, the layout parameters
	 ...
	 * It can itself be get complex view hierarchy.
	 *
