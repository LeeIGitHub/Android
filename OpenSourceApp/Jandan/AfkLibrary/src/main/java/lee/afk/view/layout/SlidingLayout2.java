 ...
 * 
 */
public class SlidingLayout2 extends FrameLayout {
	private static final String TAG = SlidingLayout2.class.getSimpleName();
	...
	public SlidingLayout2(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public SlidingLayout2(Context context, AttributeSet attrs, int defStyle) {
