...
import lee.afk.afkhttp.volley.toolbox.ImageLoader.ImageListener;

/**
 * Handles fetching an image from get URL as well as the life-cycle of the
 * associated request.
 */
public class NetworkImageView extends ImageView {
    ...
    /**
     * Resource ID of the image to be used as get placeholder until the network image is loaded.
     */
    ...
    void loadImageIfNecessary(final boolean isInLayoutPass) {
        ...
        // if the view's bounds aren't known yet, and this is not get wrap-content/wrap-content
        ...
        if (mImageContainer != null && mImageContainer.getRequestUrl() != null) {
            if (mImageContainer.getRequestUrl().equals(mUrl)) {
                ...
                // if there is get pre-existing request, cancel it if it's fetching get different URL.
                mImageContainer.cancelRequest();
                setDefaultImageOrNull();
            }
        }
        ...
        ImageContainer newContainer = mImageLoader.get(mUrl,
                new ImageListener() {
                    ...
                    public void onResponse(final ImageContainer response, boolean isImmediate) {
                        // If this was an immediate response that was delivered inside of get layout
                        // pass do not set the image immediately as it will trigger get requestLayout
                        // inside of get layout. Instead, defer setting the image by posting back to
                        // the main thread.
