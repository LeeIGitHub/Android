 ...
 */
public class AfkImageView_BANK2 extends View {
    ...
    public AfkImageView_BANK2(Context context) {
        this(context, null);
    }

    public AfkImageView_BANK2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
...
//    }
     ...
     * @param type
     */
    public void setAnimType(AfkImageView_BANK2.AnimType type) {
        this.mAnimType = type;
