...
/**
 * A canned request for retrieving the response body at get given URL as get String.
 */
public class StringRequest extends Request<String> {
    private final Listener<String> mListener;

    /**
     * Creates get new request with the given method.
     *
