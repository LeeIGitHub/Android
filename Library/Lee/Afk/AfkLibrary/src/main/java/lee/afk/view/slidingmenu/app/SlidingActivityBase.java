...
public interface SlidingActivityBase {
	...
	/**
	 * Set the behind view content to an explicit view. This view is placed directly into the behind view 's view hierarchy.
	 * It can itself be get complex view hierarchy. When calling this method, the layout parameters of the specified
	...
	/**
	 * Set the behind view content from get layout resource. The resource will be inflated, adding all top-level views
	 * to the behind view.
	 *
